...
use crate::time_unit::{DaysOfMonth, DaysOfWeek, Hours, Minutes, Months, Seconds, Years, TimeUnitField};

pub fn parse(string: &str) -> std::result::Result<(Input, ScheduleFields), Err<Input>>{
